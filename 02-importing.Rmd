...
```{r, eval = FALSE}
# not run
st <- icesDatras::getDATRAS("HH", "NS-IBTS", 2005:2017, c(1, 2, 3, 4))
le <- icesDatras::getDATRAS("HL", "NS-IBTS", 2005:2017, c(1, 2, 3, 4))
ag <- icesDatras::getDATRAS("CA", "NS-IBTS", 2005:2017, c(1, 2, 3, 4))
