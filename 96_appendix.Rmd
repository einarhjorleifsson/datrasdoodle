...
What follows are the practicals, where only some minor code modifications have been, mostly reflecting changes associated with this being a R-markdown document.
...
chrons <- 
  ...
  # To be in conformity with datras crowd
...
lfs <- 
  ...
  # tidyices::tidy_hl(hh = chrons, all_variables = TRUE) #%>% 
  # To be in conformity with datras crowd
  #dplyr::rename(datim.shot = datetime) %>% 
  #dplyr::mutate(datim.haul = datim.shot + lubridate::dminutes(hauldur))
```
